    ...
    <div class="table table-category">
        ...
        <table>
            ...
            <tr>
                ...
                <th>
                    <p class="id_room"><strong>Ngày đặt phòng </strong>:
                        <span><?php echo $book["created_time"] ?></span>
                    </p>
                    <p class="id_room"><strong>Ngày nhận phòng </strong>: <span><?php echo $book["check_in"] ?></span>
                    </p>
                    ...
                    <?php }
                                         ...
                                         ?>
                    <p><strong>Tổng thanh toán</strong> : <span> <?php echo number_format($book["price"],0,',',',')?>
                            VNĐ</span></p>
                    <?php } ?>
